...
import { LayoutGrid, Bell, User, ShieldCheck, ListChecks, Award, MoreHorizontal, Sparkles, Wallet, Briefcase, TrendingUp, Link2, Newspaper, Camera, LayoutTemplate } from "lucide-react-native";
...
function AppTabs() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="commercial" options={{ href: null, tabBarIcon: ({ color, size }) => <Briefcase color={color} size={size} /> }} />
      <Tabs.Screen name="social" options={{ href: null, tabBarIcon: ({ color, size }) => <Camera color={color} size={size} /> }} />
      <Tabs.Screen name="crm" options={{ href: null, tabBarIcon: ({ color, size }) => <TrendingUp color={color} size={size} /> }} />
      <Tabs.Screen name="crm-links" options={{ href: null, tabBarIcon: ({ color, size }) => <Link2 color={color} size={size} /> }} />
      <Tabs.Screen name="blog" options={{ href: null, tabBarIcon: ({ color, size }) => <Newspaper color={color} size={size} /> }} />
      <Tabs.Screen name="builder" options={{ href: null, tabBarIcon: ({ color, size }) => <LayoutTemplate color={color} size={size} /> }} />
      <Tabs.Screen
        name="admin"
