// Port of web's src/components/LogoMark.jsx — TEKTONE "Mineral T", three
// structural layers (Architrave / Pillar / Foundation). Keep in sync by hand.
...
export default function LogoMark({ width = 100, height = 116 }: { width?: number; height?: number }) {
  return (
    <Svg viewBox="0 0 100 116" width={width} height={height}>
      {/* Architrave */}
